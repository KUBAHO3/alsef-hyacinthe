      ...
      <section className="max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="flex items-center justify-center w-full flex-wrap max-w-screen-2xl mx-auto my-4 content-center bg-[url('https://images.pexels.com/photos/3784567/pexels-photo-3784567.jpeg')]">
          ...
          <div className="w-9/12">
            ...
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Strengthen Innovation Ecosystems</h6>
            ...
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Promote Science-Based Entrepreneurship</h6>
            ...
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Empower the Next Generation of African Life Scientists</h6>
        ...
        <div className="flex items-center justify-center w-full h-auto flex-wrap max-w-screen-2xl mx-auto my-8 content-center bg-[url('https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg')]">
          <div className="w-9/12">
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Increase Research Funding in Africa</h6>
            ...
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Strengthen Institutional Partnerships</h6>
            ...
            <div className="flex flex-col p-2 justify-between leading-normal bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <h6 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Promote Stem Education in Africa</h6>
