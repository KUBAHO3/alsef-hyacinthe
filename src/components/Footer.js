    ...
    <footer className="p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div className="mx-auto max-w-screen-xl">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="#" className="hover:underline">ALSEF Africa</a>
                            </li>
                            <li>
                                <a href="https://asm.org/Public-Engagement-1/Public-Engagement-Funding-Opportunities" className="hover:underline">Grants</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://t.me/alsef_association" className="hover:underline ">Telegram</a>
                            </li>
                            <li>
                                <a href="https://wa.me/qr/D7FXSQ3ITWFOJ1" className="hover:underline">Whatsapp</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://ALSEAfrica.com" className="hover:underline">ALSEF Africa™</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/hyacinthe.tuyubahe.9?mibextid=ZbWKwL" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://instagram.com/hyacinthe_47?igshid=NGExMmI2YTkyZg==" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://github.com/KUBAHO3" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://www.linkedin.com/in/hyacinthe-tuyubahe-38b450219" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg
