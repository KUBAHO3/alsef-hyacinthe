    ...
    <footer className="p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div className="mx-auto max-w-screen-xl">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://ALFSEForum.com" className="hover:underline">ALFSEForum™</a>. All Rights Reserved.
                </span>
