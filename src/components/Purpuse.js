  ...
  return (
    ...
    <div className="flex items-center justify-center w-full flex-wrap max-w-screen-2xl mx-auto my-4 content-center bg-[url('https://images.pexels.com/photos/3784567/pexels-photo-3784567.jpeg')]">
      <div className="w-3/12">
        <h4 className="max-w-2xl mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl flex items-center justify-center dark:text-white"  id="main_title">
          Missions
        </h4>
      </div>
